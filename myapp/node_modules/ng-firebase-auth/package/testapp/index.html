...
<body>
	...
	<header>
		<nav ng-controller="NavCtrl as nav">
			<a class="brand" href='/'> ngFireAuth </a>
			<div class="btn-group right">
				<button type="button" class="menu" data-toggle="dropdown" aria-expanded="false">
					Menu
				</button>
				<ul class="dropdown-menu dropdown-menu-right">
					...
					<li ng-show="nav.user">
						<a href='#' ng-click="nav.onLogOutClick()"> Log out </a>
					</li>
				</ul>
			</div>
		</nav>
